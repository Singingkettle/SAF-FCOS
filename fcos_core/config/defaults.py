...
# Values to be used for radar point cloud image normalization
_C.INPUT.PC_MEAN = [1.6315, 1.4805, 1.3278]
# Values to be used for radar point cloud image normalization
_C.INPUT.PC_STD = [1., 1., 1.]
# Number of channels of radar point cloud image
...
_C.DATASETS.TEST = ()
# The radius to generate the radar images
_C.DATASETS.RADAR_IMAGE_RADIUS = 7
...
# ---------------------------------------------------------------------------- #
# Backbone options for image and radar data. There are two siamese branches.
# However, the weights of the branch for radar data are all random initialized.
# ---------------------------------------------------------------------------- #
...
_C.MODEL.BACKBONE.FUSION = 'ATT1X1'
